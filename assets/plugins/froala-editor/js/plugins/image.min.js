 ...
 */
 	//var base_url_main = window.location.origin;
 	var base_url_fullpath = window.location.origin + '/' + window.location.pathname.split ('/') [1] + '/';
	var base_url = base_url_fullpath +"/admin/gallery/froala_upload_image"; //Change this path to live server
