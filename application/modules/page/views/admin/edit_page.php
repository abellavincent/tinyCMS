                ...
                <div class="card-body my-card card-spacer">
                    <div class="col-md-12 no-padding">
                        <div class="form-group">
                            ...
                            <textarea class="form-control p-input" name="content" id="content" rows="5" placeholder="Please type the page content"><?php echo stripcslashes($page[0]->content);?></textarea>
                        </div>
                        <p class="text-muted pull-right">Last modified by <?php echo ucfirst($page[0]->last_modified_by)." on ". formatDate($page[0]->date_modified)." at ". formatTime($page[0]->date_modified); ?></p>
                    </div>
                </div>
                ...
                <div class="card-body my-card card-spacer">
                    ...
                    <div class="form-group">
                        <form style="display: inline;" id="imageform-gallery" method="post" enctype="multipart/form-data" action='<?php echo site_url('admin/gallery/image_multiple_uploader');?>'>
                            ...
                            <input type="hidden" value="<?php echo $page[0]->id;?>" name="post_id"/>
                        </form>
                                ...
                                <div id="image-styling" style="border: 2px dashed #ccc; padding: 10px;overflow: hidden;" class="col-sm-12">
                                    <center>
                                        <div id="preview">
                                            ...
                                            <?php else:?>
                                                 <div class="center-cropped"><img src="<?php echo base_url().$page[0]->image;?>" class="img-responsive"></div>
                                            <?php endif;?>  
                                        </div>
                                    </center> 
                                </div>
	...
	$(document).ready(function(){
        ...
        */
        function savePage(){
            ...
            $.ajax({
                type: "POST",
                url: base_url +'admin/pages/update_page',
                dataType: 'json',
                data: {
                    title: title, 
                    content: content, 
            ...
            $("#imageform-gallery").ajaxForm({
                ...
                success: function(response) {
                    ...
                    response.forEach(function(item) {
                        $('#lightgallery').append('<a href="'+base_url +item.image_url +'" class="image-tile col-md-4" alt="image large"><img src="'+base_url +item.thumb_url +'" alt="image small"></a>');
                    });
                    console.log(response);
                }
